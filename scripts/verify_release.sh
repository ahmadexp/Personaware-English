...
package = Path("build/cf-installer/PWMINST")
...
installer = Path("dist/PersonaWare-English-CF-Installer.zip")
...
print("Verified the English 4 MiB image and backup-first CF installer")
PY
